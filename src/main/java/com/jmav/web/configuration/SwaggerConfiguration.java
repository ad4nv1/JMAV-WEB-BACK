package com.jmav.web.configuration;
...
public class SwaggerConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.jmav.web.controller"))
				.paths(PathSelectors
				.any())
				.build()
				.apiInfo(metadata())
